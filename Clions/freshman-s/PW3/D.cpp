...
void printFirstMap(pii P0, map<pii, bool> &vis)
{
    pii P1 = {1, 1};
    pii P2 = {n, m};
    int x1 = P1.first, y1 = P1.second;
...
void qurry(pii P1, pii P2)
{
    ...
    for (y; y <= mid; ++y)
    {
        ...
        if (qipan[x][y] && flag == 1)
        {
            ...
            {
                if (qipan[p1.first + 1][p1.second] == 0)
                    qipan[p1.first][p1.second + 1] = 1;
